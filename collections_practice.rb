...
def organize_schools(schools)
  ...
  schools.each do |school_name, loc_hash|
   ...
   #schools = hash of hashes of hashes
   #school's name is first key and value is another hash with key (:location) and val of city 


  # desired ====
  #organized_schools = hash of hashes with arrays
  #  org schools is first key and value is city name, which is another hash, with value equal to an array of school names 
